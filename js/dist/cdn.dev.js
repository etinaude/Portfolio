...
function addBackgroundImage(parameters) {
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    e.style.backgroundImage = "url(\"".concat(base, "/w_").concat(width, ",h").concat(height, ",").concat(mod, "/").concat(id, "\")");
  }
}
...
var large = [document.getElementsByClassName("cdn-large-img"), setWidth(100), "q_auto,c_scale", setHeight(50)]; //medium images (55%)
